...
Understanding missing values (-2, 0) (in X6-X11) from Kaggle:
...
The aim of the assignment is to compare classification machine learning algorithms and to evaluate the models base on suitable evaluation metrics.
